...
def tune_hyperparameters(
    ...
    if model_name == "NP":
        ...
        if mode == "auto":
            config = {
                "growth": tune.grid_search(["off", "linear","logistic"]),
                "n_changepoints": tune.grid_search([100]),
                "changepoints_range": tune.grid_search([0.9]),
                ...
                "n_lags": tune.grid_search([25,26,27,28,30,32,33,35,37,39]),
